...
import com.dityapra.mystoryapp.utils.MainDispatcherRule
import com.dityapra.mystoryapp.utils.getOrAwaitValue
import com.dityara.mstoryapp.utils.DataDummy
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getStories("Bearer ${storyRepository.getToken()}"))
            .thenReturn(expectedQuote)

        val mainViewModel = MainViewModel(storyRepository)
        val actualStory: PagingData<ListStoryItem> =
            mainViewModel.stories.getOrAwaitValue()
